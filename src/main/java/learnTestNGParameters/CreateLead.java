...
public class CreateLead extends ProjectSpecificWrapper {
	...
	public void creatLead() throws IOException {
		...
		File dst1 = new File("./snap/img.png");
		...
		File dst2 = new File("C:\\Users\\tasni\\eclipse-workspace1\\SeleniumProject\\snap\\img.png");
		FileUtils.copyFile(src2, dst2);

		File src3 = driver.getScreenshotAs(OutputType.FILE);
		File dst3 = new File("./snap/image3.png");
		FileUtils.copyFile(src3, dst3);

		File src = driver.getScreenshotAs(OutputType.FILE);
		File dst = new File("C:\\Users\\tasni\\eclipse-workspace1\\SeleniumProject\\snap\\img.png");
