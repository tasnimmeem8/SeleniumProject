...
public class TestLeafHomeWork1 {
	...
	public static void main(String[] args) {
		...
		driver.findElementByXPath("(//input[contains(@class,'i')])[1]").sendKeys("DemoSalesManager");// Partial
																										// Attribute
		...
		driver.findElementByCssSelector("label[for='username']+input").sendKeys("DemoSalesManager");// sibling to
																									// sibling
