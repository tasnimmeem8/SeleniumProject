...
public class TestLeafCreatLead {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		driver.findElementById("createLeadForm_description")
				.sendKeys("Contract should be signed for 3years, if not will not assigned");
		driver.findElementById("createLeadForm_importantNote")
				.sendKeys("Have to take responsibility of her own, also have to take care of the team");
