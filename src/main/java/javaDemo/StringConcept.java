...
public class StringConcept {
	...
	public static void main(String[] args) {
		...
		// System.out.println(text.equals(text1));//equals function compare the value of
		// two different variable(text & text1)
		...
		// 6.contains() -given String is available in entire String or not - return
		// true/false
