...
public class CreatLead1 {
	...
	public void creatLead () {
		...
		System.out.println("First window ref= "+driver.getWindowHandle());
		System.out.println("Page Title= "+driver.getTitle());
		System.out.println("Title length= "+driver.getTitle().length());
		System.out.println("Contain Leaf in title= "+ driver.getTitle().contains("Leaf"));
		System.out.println("Contain leaf in title= "+driver.getTitle().contains("leaf"));
		...
		System.out.println("Title Hash code= "+System.identityHashCode("driver.getTitle()"));
		System.out.println("drivers Hash code= "+System.identityHashCode(driver));
		System.out.println("       ");
